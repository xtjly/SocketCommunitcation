...
namespace FastSocket.Server
{
    public interface IFastSocketService
    {
        ...
        Action<FastSocket, FastSocketConnection> OnConnectionCloseed { get; set; }
        ...
        IFastSocketService AddOnConnectionCloseed(Action<FastSocket, FastSocketConnection> action);
